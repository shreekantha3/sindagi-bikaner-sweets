# Bikarner Sweets — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-bikaner-sweets/
- **Repo:** `shreekantha3/sindagi-bikaner-sweets` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-bikaner-sweets/'` for GitHub Pages project-site hosting.
